...
export default function CoopWaitingRoom({
  players,
  currentPlayer,
  invitation,
  onInvite,
  ...
  return (
    <Fragment>
      ...
      <div className='flex flex-col items-center justify-center h-screen text-white'>
        <h1 className='text-4xl font-bold mb-8 text-2p'>⚔️ <strong className='text-blue-400'>WIZZARD</strong> <i className='text-green-400'>COOPERATION</i> ⚔️</h1>
        <p className='text-center text-poppins mb-10'>Fight alongside your teammates to defeat enemies like the fire mage and the dragon.</p>
        ...
        <Modal isOpen={!!invitation} onClose={() => onRespondInvitation(false)}>
          <ModalContent>
            <ModalHeader>
              <h1 className='text-2p text-2xl'>INVITATION FOR COOPERATION</h1>
            </ModalHeader>
            <ModalBody>
              <p className='text-poppins'>{invitation?.fromName} Invites you to defeat hostile forces!</p>
            </ModalBody>
            <ModalFooter>
              <Button
                color='danger'
